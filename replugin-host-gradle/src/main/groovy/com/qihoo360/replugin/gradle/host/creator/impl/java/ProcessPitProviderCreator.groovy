 ...
 */
public class ProcessPitProviderCreator implements IFileCreator {

    def static final FILE_PATH = '/com/qihoo360/replugin/component/process/'
    def static final FILE_NAME_PREFIX = 'ProcessPitProviderP'
    ...
    def ProcessPitProviderCreator(def project, def variant, def cfg, def pn) {
 ...
 */
public class ProcessPitProviderP${pn} extends ProcessPitProviderBase {
}"""
    }
}
